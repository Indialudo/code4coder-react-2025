...
//import "./AboutMain.css"; // Optional: for any CSS module handling
        ...
        <div className="flex gap-5 md:flex-row flex-col">
          ...
          <div className="md:w-1/2 w-full">
            ...
            <h3 className="text-2xl lg:text-5xl md:text-4xl sm:text-3xl font-bold title-font mb-4 capitalize">
              ...
              <FaCode className="text-darkyellow inline" /> -learning coding best platform
            </h3>
            ...
            <div className="flex md:flex-row flex-col gap-3">
              ...
              <div className="md:w-1/2 w-full pr-3 items-center sm:gap-3 gap-1 flex flex-wrap">
                ...
                <div className="flex flex-col">
                  <span className="capitalize text-gray-500">Placement Reports</span>
            ...
            {/* <button className="bg-darkyellow mt-5 text-white hover:text-black font-medium text-lg px-10">Read more</button> */}
          </div>
        </div>
      </div>
    </section>
